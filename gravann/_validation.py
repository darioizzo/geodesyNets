...
from ._losses import contrastive_loss, normalized_loss, normalized_L1_loss, normalized_relative_L1_loss
...
def validation_results_df_to_string(validation_results):
    ...
    for idx, val in validation_results.iterrows():
        result_strings[val["Altitude"]
                       ] = f'ContrL={val["Contrastive Loss"]:.3e},NormL1={val["Normalized L1 Loss"]:.3e},NormL2={val["Normalized Loss"]:.3e},RelNormL2={val["Normalized Rel. L1 Loss"]:.3e}'
...
def validation(model, encoding, mascon_points, mascon_masses,
    ...
    loss_fns = [contrastive_loss, normalized_L1_loss,
                normalized_loss, normalized_relative_L1_loss]
    cols = ["Altitude", "Contrastive Loss",
            "Normalized L1 Loss", "Normalized Loss", "Normalized Rel. L1 Loss"]
    ...
    for loss_fn in loss_fns:
        if loss_fn == contrastive_loss or loss_fn == normalized_relative_L1_loss:
